  ...
  const actions = [
    {
      ...
      icon: User,
      active: location.pathname === '/profile' && (!currentTab || currentTab === 'personal'),
    },
    {
      label: 'Settings',
      ...
      icon: Settings,
      active: location.pathname === '/profile' && (currentTab === 'preferences' || currentTab === 'security'),
    },
    {
      label: 'Study plan',
    ...
    {
      label: 'Notifications',
      detail: 'Reminders and booking updates',
      href: '/notifications',
      icon: Bell,
